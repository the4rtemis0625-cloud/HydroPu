    ...
    <div className="min-h-screen bg-background flex flex-col font-body">
      ...
      <main className="flex-1">
        ...
        <section className="relative w-full max-w-7xl mx-auto px-6 py-16 flex flex-col items-center text-center">
          ...
          {/* Waving line animation - Spans full content width with infinite seamless loop */}
          <div className="relative w-full h-8 overflow-hidden mt-8">
            <div className="absolute inset-0 flex items-center">
              <svg className="w-[3000%] h-full text-accent opacity-40 animate-wave" viewBox="0 0 2400 40" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
